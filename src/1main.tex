...
%\input{"\DenKrAllMainRootDir/makros_draftPhase".tex}% Values in this are required for some sophisticated Macros from "makros_typografie" (e.g. Framed-Image-Matrix). If no such are used, this File is dispensable
...
%========================================================================
% ----  Content
% ----     (Choose exclusively one Method below)
%------------------------------------------------------------------------
\newcommand{\DenKrDispositionFILE}{3Disposition}%
\newcommand{\DispositionInput}[1]{\input{"\DenKrSetupFilesSubDirPrefix\DenKrDispositionFILE_#1".tex}}%
% % -- Automatic Self-Setting-Up
\DenKrITEequal{\DenKrDocGenre}{elaborate}{%
	\DispositionInput{book}%
}{\DenKrITEequal{\DenKrDocGenre}{slides}{%
	\DispositionInput{slides}%
}{\DenKrITEequal{\DenKrDocGenre}{dedicated_poster}{%
	\DispositionInput{article}%
}{}}}%
% % -- Manual Setting
% \DispositionInput{book}%
% \DispositionInput{slides}%
