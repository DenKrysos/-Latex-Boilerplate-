...
\usepackage{polyglossia}% [babelshorthands]
%\AddToHook{begindocument/before}{\usebabelshorthands{german}}% Because loading order messes with activation of shorthands
\usebabelshorthands{german}%
\setmainlanguage[variant=american]{english}% Synonym: \setdefaultlanguage
\setotherlanguage[spelling=new]{german}%
%\selectlanguage{japanese}%
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
% Remark that "british" switches the double-single quotation style.
