...
\renewcommand*\DenKrKOMAHookFormatChapter[3]{%
	...
	\begin{tikzpicture}[baseline=(chapter_title.base)]%
		...
		\Ifthispageodd{%Right
			...
			\colorlet{DenKrKomaColor_ChapterHeading_Right}{DenKrKomaColor_ChapterHeading!60!white}%
			\renewcommand\raggedchapterPrint{\raggedleft}%
			\def\ShiftDirection{}%
		}{%Left
			\def\nodeAnch{west}%
			\def\nodeAnchOpposite{east}%
			\colorlet{DenKrKomaColor_ChapterHeading_Left}{DenKrKomaColor_ChapterHeading!60!white}%
		...
		%
		% Background
		\node[outer sep=0pt,inner sep=5pt,shade,left color=DenKrKomaColor_ChapterHeading_Left,right color=DenKrKomaColor_ChapterHeading_Right](chapter_title){%
			\parbox[t]%
			{\dimexpr\textwidth-10pt\relax}%
			{\raggedchapterPrint\textcolor{DenKrKomaColor_ChapterHeading!85!black}{#3}}%
		};%
		% Chapapp
