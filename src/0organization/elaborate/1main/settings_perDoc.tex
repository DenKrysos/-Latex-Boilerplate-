...
\makeatletter%
\@ifundefined{ifChapterExists}{}{%
	\ifChapterExists%
	\@ifundefined{theequation}{}{\renewcommand\theequation{\arabic{chapter}.\arabic{equation}}}%
	\@ifundefined{thealgorithm}{}{\renewcommand\thealgorithm{\arabic{chapter}.\arabic{algorithm}}}%
	\else\fi%
}%
\makeatother%
%
...
%					- floats
%					- Some new Lengths & Variables
%					- Basic Layout, Typesetting, LaTeX
%/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
%\setlength{\parskip}{0ex plus 0pt minus 0pt}% Default value is 0pt plus 1pt   %Latex Std is \setlength\parskip{0\p@ \@plus \p@}
%\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/
%			Spacing End
%------------------------------------------------------------------------
%________________________________________________________________________
