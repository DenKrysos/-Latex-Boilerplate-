...
% USAGE EXAMPLE:
%==================================================================================
% ----  Set-Up of Typography (Recipe Typesetting Macros)
%----------------------------------------------------------------------------------
% draftPhaseSet[...]  - Set to '1' to:
%     Global: Sets the 3 below simultaneously
...
%		%----------------------------------
%		%----------------------------------
%		% Some Settings take immediate effect (with the setting-Macros above). Others only set some Flag or Preference (e.g. the 'SimpleTypografie'). This Flag can then be overwritten (e.g. by the '\phaseSetRelease'). Finally, this Macro below modifies more complex overall Document-Settings, according to the current state of the Flag.
