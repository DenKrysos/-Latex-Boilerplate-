...
%=================================
% USAGE: \begin{itemize}[labsigA]   or   \item[\labsigAsym]
%   (Standing for: Label-Prägnanz-# (EN: Conciseness)
%   (The \labsig#sym can be used for single items as they do only define the Symbol itself
...
\newcommand{\labsigAsym}{\raisebox{.5\height}{\textbf{\scriptsize$\rightarrow$}}}%
\newcommand{\labsigBsym}{\raisebox{.5\height}{\textbf{$\scriptstyle\Rightarrow$}}}%
\newcommand{\labsigCsym}{\raisebox{.5\height}{\scalebox{0.7}{$\pointright$}}}%
\newcommand{\labsigDsym}{\raisebox{.4\height}{\scalebox{0.7}{$\blacktriangleright$}}}%
\newcommand{\labsigEsym}{\raisebox{.1\height}{\scalebox{0.6}{\compoundarrow}}}%
%================================================
% Presets for Usage as Enumeration Label
%=================================
\newcommand{\labnumArabDot}{\arabic*.}%
\newcommand{\labnumArabParen}{\arabic*)}%
\newcommand{\labnumArabPParen}{(\arabic*)}%
\newcommand{\labnumRomUpDot}{\Roman*.}%
\newcommand{\labnumRomUpParen}{\Roman*)}%
\newcommand{\labnumRomUpPParen}{(\Roman*)}%
\newcommand{\labnumRomLowDot}{\roman*.}%
\newcommand{\labnumRomLowParen}{\roman*)}%
\newcommand{\labnumRomLowPParen}{(\roman*)}%
\newcommand{\labnumAlphUpDot}{\Alph*.}%
\newcommand{\labnumAlphUpParen}{\Alph*)}%
\newcommand{\labnumAlphUpPParen}{(\Alph*)}%
\newcommand{\labnumAlphLowDot}{\alph*.}%
\newcommand{\labnumAlphLowParen}{\alph*)}%
\newcommand{\labnumAlphLowPParen}{(\alph*)}%
%=================================
% Label-Presets END
%================================================
%
...
% Pure TeX Solution (requires amsmath.sty)
% => Since babelshorthands doesn't reliably work with LuaLaTex
\makeatletter%
% \newcommand{\allowhyphens}{\penalty\@M\hskip\z@skip}%  already defined
\newcommand{\hyphdash}{\allowhyphens\discretionary{-}{}{-}\allowhyphens}%
\makeatother%
%
