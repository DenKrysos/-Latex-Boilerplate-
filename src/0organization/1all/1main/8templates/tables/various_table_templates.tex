...
%-------------------------------
%  ToDo: That's not working reliably. Can't do a \stepcounter in a Cell that involved in a \multirow or \multicolumn
\newcounter{DenKrRowColAlternating}%
\newcommand{\DenKrRowColAlternatingInit}[2]{%
	\setcounter{DenKrRowColAlternating}{0}%
	\def\DenKrRowColAlternatingColA{#1}%
	\def\DenKrRowColAlternatingColB{#2}%
}%
\newcommand{\DenKrRowColAlternate}{%
	\stepcounter{DenKrRowColAlternating}%
	\ifodd\value{DenKrRowColAlternating}%
		\rowcolor{\DenKrRowColAlternatingColA}%
	\else%
		\rowcolor{\DenKrRowColAlternatingColB}%
	\fi%
}%
\DenKrRowColAlternatingInit{cell_accentuated}{cell_bright}%
%-------------------------------
%
%
%
