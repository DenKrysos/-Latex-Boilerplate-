...
\newcommand{\nli}{\par}% Abbr. for NewLine (with-Indentation)
...
%
%-----------------------------
% To store and restore the current paragraph spacing settings (e.g. call before and inside a minipage to retain the indentation)
\makeatletter%
\newcommand{\parcfgstore}{%
    \edef\denkr@parindent{\the\parindent}%
    \edef\denkr@parskip{\the\parskip}%
}%
\newcommand{\parcfgset}{%
    \setlength{\parindent}{\denkr@parindent}%
    \setlength{\parskip}{\denkr@parskip}%
}%
\makeatother%
\parcfgstore%
%
...
%
\makeatletter%
\newcommand{\formatnumnamref}[1]{%
	\hyperref[#1]{\formatrefLabelFormat{\namecref{#1}} \formatrefNumFormat{\ref*{#1}} \formatnamref{\formatrefFormat{\nameref*{#1}}}}%
}%
\makeatother%
\def\entityformatnumnamref{\formatnumnamref}%
\def\eleformatnumnamref{\formatnumnamref}%
\def\typeformatnumnamref{\formatnumnamref}%
% - - - - - - - - - - - - - - - -
% Nameref with some fancy formatting
% - - Setup for it
\newcommand{\formatrefLabelFormat}[1]{{\color{DenKrKomaColor_ChapterHeading!55!black}#1}}%
\newcommand{\formatrefNumFormat}[1]{{\color{DenKrKomaColor_ChapterHeading!85!black}#1}}%
...
\newcommand{\furtherrefFormat}[1]{{%
	\formatquotrefFormat{#1}%
}}%
\newcommand{\furtherrefPrefix}[1]{{%
	$\rightarrow$ {#1}%
}}%
\newcommand{\furtherrefBraces}[1]{{%
	({#1})%
}}%
\newcommand{\furtherrefNoB}[1]{{%
	\furtherrefPrefix{\hyperref[#1]{\furtherrefFormat{\nameref*{#1}}}}%
}}%
\newcommand{\furtherref}[1]{{%
	\furtherrefBraces{\furtherrefNoB{#1}}%
}}%
