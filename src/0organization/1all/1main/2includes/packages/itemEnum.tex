...
% - - - - - - - -
% % To just have "no Label at all"
\SetEnumitemKey{nolabel}{label=,leftmargin=0pt}%
%
%---------------------------
% %  List-Style Settings
% - - - - - - - -
...
\renewcommand{\descriptionlabel}[1]{\DenKrDescriptionlabelMake{#1}}%
%
%---------------------------
% %  New List Type: Enumerated-Description
% - - - - - - - -
\newcounter{descenum}%
...
\renewcommand{\DenKrDescenumlabelAssemble}[1]{\stepcounter{descenum}\DenKrDescenumlabelMake{#1}{descenum}}%
%
\newcommand{\DenKrDescenumChangeitem}{%
	% \let\latexitem\item%
	% \renewcommand\item[1][]{\latexitem\relax{\bfseries##1} }%
	\renewcommand\makelabel[1]{\DenKrDescenumlabelAssemble{##1}}%
}%
\newenvironment{descenum}[1][]%
	{\begin{description}[before=\DenKrDescenumChangeitem,#1]}%
	{\end{description}}%
%
%
%
...
%---------------------------
% %  My "Significance / (Signifikanz)" Symbols, i.e. are supposed to indicate labeled expressions are risingly "crucial / determinative / decisory"
%    (Their leftmargins are set, so that they align with each other
% - - - - - - - -
\SetEnumitemKey{labsigA}{label=\labsigAsym,align=right,leftmargin=1.3em}%1.25em
\SetEnumitemKey{labsigB}{label=\labsigBsym,align=right,leftmargin=1.3em}%1.3em
\SetEnumitemKey{labsigC}{label=\labsigCsym,align=right,leftmargin=1.3em}%1.3em
\SetEnumitemKey{labsigD}{label=\labsigDsym,align=right,leftmargin=1.3em}%1.2em
\SetEnumitemKey{labsigE}{label=\labsigEsym,align=right,leftmargin=1.3em}%1.3em
%---------------------------
...
%---------------------------
% %  Labeling Enumerates in different Formats
% - - - - - - - -
\SetEnumitemKey{labnumArabDot}{label=\labnumArabDot,align=right,leftmargin=*}%
\SetEnumitemKey{labnumArabParen}{label=\labnumArabParen,align=right,leftmargin=*}%
\SetEnumitemKey{labnumArabPParen}{label=\labnumArabPParen,align=right,leftmargin=*}%
\SetEnumitemKey{labnumRomUpDot}{label=\labnumRomUpDot,align=right,leftmargin=*}%
\SetEnumitemKey{labnumRomUpParen}{label=\labnumRomUpParen,align=right,leftmargin=*}%
\SetEnumitemKey{labnumRomUpPParen}{label=\labnumRomUpPParen,align=right,leftmargin=*}%
\SetEnumitemKey{labnumRomLowDot}{label=\labnumRomLowDot,align=right,leftmargin=*}%
\SetEnumitemKey{labnumRomLowParen}{label=\labnumRomLowParen,align=right,leftmargin=*}%
\SetEnumitemKey{labnumRomLowPParen}{label=\labnumRomLowPParen,align=right,leftmargin=*}%
\SetEnumitemKey{labnumAlphUpDot}{label=\labnumAlphUpDot,align=right,leftmargin=*}%
\SetEnumitemKey{labnumAlphUpParen}{label=\labnumAlphUpParen,align=right,leftmargin=*}%
\SetEnumitemKey{labnumAlphUpPParen}{label=\labnumAlphUpPParen,align=right,leftmargin=*}%
\SetEnumitemKey{labnumAlphLowDot}{label=\labnumAlphLowDot,align=right,leftmargin=*}%
\SetEnumitemKey{labnumAlphLowParen}{label=\labnumAlphLowParen,align=right,leftmargin=*}%
\SetEnumitemKey{labnumAlphLowPParen}{label=\labnumAlphLowPParen,align=right,leftmargin=*}%
%
%
%
%
