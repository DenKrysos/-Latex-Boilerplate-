...
% - IEEEtran % Most IEEE Conferences. For this, compile with "pdflatex"
...
%
%<><><><><><><><><><><><><><><><><><><><><>
%<> <>  Document-Genre: slides       <><><>
%<> <>         (aka presentation)    <><><>
%<-><-><-><-><-><-><-><-><-><-><-><-><-><->
% - beamer % Probably the most well-known
% - powerdot % NOT IMPLEMENTED. Another hot contester. Haven't tried it thoroughly yet.
%
%
%<><><><><><><><><><><><><><><><><><><><><>
...
%<> <>  Setting the Values           <><><>
%<-><-><-><-><-><-><-><-><-><-><-><-><-><->
\providecommand{\DenKrLayout}{scrbook}%
\providecommand{\DenKrLayoutLanguage}{english}% en_ger, english, ngerman
\providecommand{\DenKrGlossaryPrint}{1}% 0: Not printing Glossaries at end-of-document (Acronyms, etc. are still available, just no listing at the end is printed)  |  1: true aka USE Hyperref
\providecommand{\DenKrLayoutUseHyperref}{1}% 0: false aka NOT use Hyperref  |  1: true aka USE Hyperref
% Only for 'dedicated'
\providecommand{\DenKrBlindReview}{0}% 0: NO Blind-Review, i.e. keep Authors in  |  1: Don't print Authors
%
...
\providecommand{\DenKrCommentsUsage}{1}% 1: Enabled  |  0: Disabled, Comment-Macros don't do anything
%----------------------------------------------------------------------------------
% - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
%==================================================================================
%
...
% % % % % % %
\providecommand{\DenKrSupplyRootDirPATH}{1supply}%
\providecommand{\DenKrContentRootDirPATH}{9chapter}%
\providecommand{\DenKrTablesRootDirPATH}{5tables}%
\providecommand{\DenKrListingsRootDirPATH}{6listings}%
\providecommand{\DenKrTikzRootDirPATH}{7Tikz}%
\providecommand{\DenKrGraphicsRootDirPATH}{8graphics}%
\providecommand{\DenKrAlgorithmRootDirPATH}{\DenKrListingsRootDirPATH}%
\providecommand{\DenKrLiteratureDirPATH}{\DenKrSupplyRootDirPATH}%
...
%----------------------------------------------
%----------------------------------------------
\providecommand{\DenKrSegmentationSubDirPATH}{\DenKrContentRootDirPATH/0segmentation}%
...
%-------------------------------------------------------------------------
\providecommand{\DenKrLayoutIncludeBiographies}{0}% 1: Print the Biographies after Literature-References  |  0: Don't print Biographies
%
%
%
%==================================================================================
...
\providecommand{\DenKrJPFont}{0}% 1: Also make Japanese Fonts available  |  0: Don't setup Japanese Fonts
%
...
\DeclareDocumentCommand{\setDocGenre}{}{%
	...
	% Slides / Presentation
	\setDocGenreIf{slides}{beamer}{%
	\setDocGenreIf{slides}{powerdot}{%
	% Poster
