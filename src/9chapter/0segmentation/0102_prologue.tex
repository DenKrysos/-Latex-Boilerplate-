...
\item
    ...
    % \item
    %     There are multiple Literature Registers:
    %     \begin{itemize}
    %         \item Titled \hyperref[chap:literature]{\gerguiquote{\nameref*{chap:literature}}} for the \textit{primary} literature.
    %         \item A distinct Regsiter for \hyperref[chap:literature_techspec]{\gerguiquote{\nameref*{chap:literature_techspec}}}.
    %         \item And utilized or otherwise referenced tools or products in \hyperref[chap:literature_tools]{\gerguiquote{\nameref*{chap:literature_tools}}}.
    %     \end{itemize}
    \end{itemize}
\item
