...
\begin{itemize}
    \item Compiler: \texttt{\textcolor{DenKrKomaColor_Violet_3}{LuaLaTeX}}
    \item (Empfohlene) Toolchain: \texttt{\textcolor{DenKrKomaColor_Violet_3}{TeXLive-\textbf{2025}}}
    \item[-] - - - - - - - - - - -
    \item Git Funktion von Overleaf: Links oben \enquote*{\textit{Menu}} $\rightarrow$ \enquote*{\textit{Git}} $\rightarrow$ Git-Clone
    \item Das Projekt ist vorbereitet, einfach mit \texttt{\textcolor{DenKrKomaColor_Violet_3}{VSCode}} kompiliert zu werden:
        \begin{itemize}
            \item Install Extension \enquote{\textit{\textcolor{DenKrKomaColor_Violet_1}{LaTeX Workshop}}}
                \begin{itemize}
                    \item \textit{(Optional)} eventuell ebenso: \enquote{\textit{\textcolor{DenKrKomaColor_Violet_1}{LaTeX Utilities}}}, \enquote{\textit{\textcolor{DenKrKomaColor_Violet_1}{LTeX+ – grammar/spell checking using LanguageTool}}}
                \end{itemize}
